...
weights1 = {"0": 0.97, "1": 0.03}
weights2 = {"0": 0.5, "1": 0.5}  # importance weights for some models
...
params_nb = {"alpha": [1, 2, 10], "fit_prior": [True, False]}
...
train, test = train_test_split(
    df.df, test_size=0.2, random_state=123, stratify=df.df["Survived"]
)  # spliting data
